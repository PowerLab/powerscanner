...
public class UMLoggerService extends Service {
	...
	public void onDestroy() {
		...
		if (!foregroundSet) {
			// setForeground(false); //service priority up, so just sdk 1.6 is
			// possible. android 2.0 above unpossible
	...
	public void showNotification() {
		...
		Intent notificationIntent = new Intent(this, PM_MainActivity.class);
		...
		if (!foregroundSet) {
			// setForeground(true); //service priority up, so just sdk 1.6 is
			// possible. android 2.0 above unpossible
