...
public class PassionConstants extends DreamConstants {
  ...
  //원래값 : brightnees : 1.2217 , 3.194(bright)
  ...
  //base power 를 변경한다. 원래값 : 365 / 변경값 : 148.3
  public double oledBasePower() {
    return 148.3; // This incorporates all the constant component in the model.
  }
